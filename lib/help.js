...
┏ ❣ *IUHA BOT* ❣
   ...
   ┠❥ *!stickergif* (!sgif)
   ┠❥ *!stickernobg* (!snobg)
   ┠❥ *!giphy2sticker* (giphy url)
   ┠❥ *!vid2sticker* (video url)
   ┠❥ *!ttp* (text2sticker)
   ┠❥=========================
   ┠❥======= LOTERIAS  =======
   ┠❥ *!megasena*
   ...
   ┠❥=========================
   ┠❥=======   OTHER  ========
   ┠❥ *!clima* (Meteorologia do dia)
   ┠❥ *!meme* (random meme)
   ┠❥ *!wait* (what anime is this)
   ┠❥ *!cao*	(random cao)
   ┠❥ *!gato* (random gato)
   ┠❥ *!sexta* (baka only)
   ┠❥ *!sextaespecial* (baka only)
   ┠❥ *!macaco* (random macaco)
   ┠❥ *!letra*
   ┠❥ *!tts* (en, pt) (text2audio)
   ┠❥ *!roll* (rpg roll)
   ┠❥=========================
   ┠❥=======   NSFW   ========
   ┠❥ *!rr* (random)
